...
package com.android.systemui.ancient.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.ancient.header.STATUS_BAR_HEADER_UPDATE";
